...
def get_args():
    ...
    parse.add_argument('--model', type=str, default='gpt-4o')
    parse.add_argument('--LLM_freq', type=int, default='gpt-4o')

    parse.add_argument('--windows_length', type=int, default=1000, help='windows_length')
    ...
    parse.add_argument('--c', type=float, default=0.1, help='c')
    parse.add_argument('--RL_ucb', type=int, default='RL_ucb')
    parse.add_argument('--Inter_Loop_freq', type=int, default='Inter_Loop_freq')
    parse.add_argument('--ucb_type', type=str, default='mean')
    parse.add_argument('--buffer_transfer', type=int, default=0, help='buffer_transfer')
    parse.add_argument('--tau_type', type=str, default='normal')
    parse.add_argument('--scale_type', type=str, default='scale_type')
