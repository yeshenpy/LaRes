            ...
            while True:
                try:
                   # other_rewards.append(rf(*input)[0]*Final_reward_scale[index_index])
                    ...
                    #                                   task_obs_code_string_2, input_dict_string, code_output_tip, index_index)
                    # reward_function_pop[index_index] = reward_function_pop_one[0]
                    # reward_input_name_pop[index_index] = reward_input_name_pop_one[0]
                    # reward_string_pop[index_index] = reward_string_pop_one[0]
...
if __name__ == '__main__':
    ...
    # elif args.Type == 1 :
    #     improvement_suggesstion = file_to_string(f'{prompt_dir}/suggesstions-V2.txt')
    #     init_suggesstion = file_to_string(f'{prompt_dir}/init_suggestions-V2.txt')
    ...
    "door-close-v2": """{
      ...
      "obj": "Current position of the door",
